...
class IcomeControllerScreen extends StatefulWidget {
  const IcomeControllerScreen({super.key});

  @override
  State<IcomeControllerScreen> createState() => _IcomeControllerScreenState();
}

class _IcomeControllerScreenState extends State<IcomeControllerScreen> {
  List<FlSpot> dataSet = [];

  DateTime today = DateTime.now();
  List<FlSpot> getIcomechartDatas(List<TransactionModel> entireData) {
    dataSet = [];
    List tempDataSet = [];
            ...
            builder: ((context, snapshot) {
              if (snapshot.hasError) {
                ...
                if (snapshot.data!.isEmpty) {
                  ...
                  getIcomechartDatas(snapshot.data!);
                  return Padding(
                        ...
                        : Column(
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  'Your ${Utilities().getMonthName(today)} month income graph :-',
                                  style: GoogleFonts.robotoCondensed(
